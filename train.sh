...
WANDB__SERVICE_WAIT=300 WANDB_MODE=offline python3 -m EasyLM.models.mistral.mistral_train \
    ...
    --tokenizer.vocab_file='gs://hxtpu_bucket/chinese_mistral_tokenizer.model' \
    --load_dataset_state='gs://hxtpu_bucket/regional_sea_mistral_7b_outputs2/EasyLM-3--mix_sea_mc/dataset.pkl' \
    --load_checkpoint='trainstate::gs://hxtpu_bucket/regional_sea_mistral_7b_outputs2/EasyLM-3--mix_sea_mc/streaming_train_state' \
    ...
    --eval_dataset.json_dataset.batch_size=256 \
