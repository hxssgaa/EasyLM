...
WANDB__SERVICE_WAIT=300 WANDB_MODE=offline python3 -m EasyLM.models.mistral.mistral_train \
    ...
    --eval_steps=4 \
    --save_model_freq=512 \
    --save_milestone_freq=8192 \
    --save_best=True \
    --best_metric='eval_accuracy' \
    --load_mistral_config='7b_lora'\
    --tokenizer.vocab_file='gs://hxtpu_bucket/chinese_mistral_tokenizer.model' \
    --load_checkpoint='trainstate_params::gs://hxtpu_bucket/regional_sea_mistral_7b_outputs2/EasyLM-11--mix_sea_mc/streaming_train_state_71680' \
    ...
    --logger.output_dir='gs://hxtpu_bucket/regional_sea_mistral_7b_instruction_outputs/' \
    --logger.online=True \
